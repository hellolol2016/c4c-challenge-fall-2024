  ...
  partners: [
    {
      id: 1,
      name: "Facebook",
      thumbnail: "/projects/facebook.png",
      active: true,
      description:
...

    {
      id: 2,
      name: "Instagram",
      thumbnail: "/projects/instagram.png",
      active: false,
      description:
        "Instagram is a social media platform primarily focused on sharing photos and videos, featuring various interactive elements such as stories, reels, and direct messaging.",
    },

    {
      id: 3,
      name: "Lego",
      thumbnail: "/projects/lego.png",
      active: true,
      description:
        "Lego is a popular toy brand known for its interlocking plastic bricks that can be assembled to create various models and structures. ",
    },
  ],
};
